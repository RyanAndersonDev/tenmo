...
public class App {
	...
	private void sendBucks() {
        ...
        BigDecimal sendAmount = consoleService.promptForBigDecimal("Enter amount: $");
        TransferInput input = new TransferInput(recipientId, sendAmount);
        transferService.pay(input);
	}
